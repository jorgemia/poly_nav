...
geometry_msgs::TransformStamped hokuyo_transformStamped;
...
double x[720] = {0}, y[720] = {0}, theta[720] = {0}, scan_pts_index_array[720] = {0}, yaw = 0, error = 0, w_p = 0.1, w_b = 0.1;
...
tf::StampedTransform hokuyo_transform;
tf::TransformListener hokuyo_listener;

ros::NodeHandle nh_;
ros::Publisher marker_pub_1, marker_pub_2, marker_pub_3, point_pub, twist_gazebo, landmarks_pub, a_err;
ros::Subscriber scan_sub, pose_sub, hpose_sub;
