#include "poly_nav_row_following.h"
    ...
    bIndex_1 = scan_pts_index_array[line_1_pt_2];
     if ((aIndex_1 != bIndex_1) && (y[aIndex_1] != 0) && (x[aIndex_1] != 0) && (y[bIndex_1] != 0) && (x[bIndex_1] != 0)){ // Line Model parameters
      ...
      // Conditions Check
        ...
        if(std::fabs(atan2(y[second_pt]-y[first_pt],x[second_pt]-x[first_pt]))> 0.2) goto skip_line;
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "poly_nav_row_following");
